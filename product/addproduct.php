    ...
    <!-- call ajax page -->
    <div data-role="page" id="callAjaxPage" data-url="callAjaxPage" class="ui-page ui-body-b ui-page-active">
        <div data-role="header" class="ui-bar-b ui-header" role="banner">
            ...
            <h1 class="ui-title" tabindex="0" role="heading" aria-level="1">Thêm sản phẩm</h1>
        </div>
        ...
        <div data-role="content" class="ui-content" role="main">
            <form id="callAjaxForm">
                <div data-role="fieldcontain" class="ui-field-contain ui-body ui-br">
					...
					<label for="xuatxu" class="ui-input-text">Xuất xứ</label>
                    <input type="text" name="xuatxu" id="xuatxu" value="" class="ui-input-text ui-body-null ui-corner-all ui-shadow-inset ui-body-c">
					...
					<p>		
					<button id="submit" type="submit" class="ui-btn-hidden" aria-disabled="false">Thêm sản phẩm</button>
